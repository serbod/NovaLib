...
{ ---------------------------------------------------------------------------- }
{ QC #37403: ALT Key press causes controls to disappear under Themes in Vista and XP }
{$IFDEF AltKeyFix}
type
  TPatchedCheckBox = class(TCheckBox)
    procedure NewCreateParams(var Params: TCreateParams);
  end;

  TPatchedButton = class(TButton)
    procedure NewCreateParams(var Params: TCreateParams);
  end;

  TPatchedRadioButton = class(TRadioButton)
    procedure NewCreateParams(var Params: TCreateParams);
  end;

  {TPatchedButtonControl = class(TButtonControl)
    procedure NewCreateParams(var Params: TCreateParams);
  end; }
...
procedure TPatchedCheckBox.NewCreateParams(var Params: TCreateParams);
begin
  inherited CreateParams(Params);
...
procedure TPatchedButton.NewCreateParams(var Params: TCreateParams);
begin
  inherited CreateParams(Params);
  if CheckWin32Version(5, 1) then
    Params.ExStyle := Params.ExStyle or WS_EX_COMPOSITED;
...
procedure TPatchedRadioButton.NewCreateParams(var Params: TCreateParams);
begin
  inherited CreateParams(Params);
  if CheckWin32Version(5, 1) then
    Params.ExStyle := Params.ExStyle or WS_EX_COMPOSITED;
...
{procedure TPatchedButtonControl.NewCreateParams(var Params: TCreateParams);
begin
  inherited CreateParams(Params);
  if CheckWin32Version(5, 1) then
    Params.ExStyle := Params.ExStyle or WS_EX_COMPOSITED;
...
procedure InitAltKeyFix;
begin
  DebugLog('AltKeyFix');
  ReplaceVmtField(TCheckBox, @TPatchedCheckBox.CreateParams, @TPatchedCheckBox.NewCreateParams);
  ReplaceVmtField(TButton, @TPatchedButton.CreateParams, @TPatchedButton.NewCreateParams);
  ReplaceVmtField(TRadioButton, @TPatchedRadioButton.CreateParams, @TPatchedRadioButton.NewCreateParams);
  //ReplaceVmtField(TButtonControl, @TPatchedButtonControl.CreateParams, @TPatchedButtonControl.NewCreateParams);
end;

procedure FiniAltKeyFix;
begin
  ReplaceVmtField(TCheckBox, @TPatchedCheckBox.NewCreateParams, @TPatchedCheckBox.CreateParams);
  ReplaceVmtField(TButton, @TPatchedButton.NewCreateParams, @TPatchedButton.CreateParams);
  ReplaceVmtField(TRadioButton, @TPatchedRadioButton.NewCreateParams, @TPatchedRadioButton.CreateParams);
  //ReplaceVmtField(TButtonControl, @TPatchedButtonControl.NewCreateParams, @TPatchedButtonControl.CreateParams);
end;
{$ENDIF AltKeyFix}
{---------------------------------------------------------------------------}
...
{ ---------------------------------------------------------------------------- }
{ QC #37403: ALT Key press causes controls to disappear under Themes in Vista and XP }
{$IFDEF ImageFlickerFix}
type
  TFlickerlessImage = class(TImage)
    procedure NewWndProc(var Msg: TMessage);
  end;

procedure TFlickerlessImage.NewWndProc(var Msg: TMessage);
begin
  { Instead of hooking the DMT we simply call the replacement handlers directly }
  case Msg.Msg of
    WM_ERASEBKGND:
...
procedure InitImageFlickerFix;
begin
  DebugLog('ImageFlickerFix');
  ReplaceVmtField(TImage, @TFlickerlessImage.WndProc, @TFlickerlessImage.NewWndProc);
end;

procedure FiniImageFlickerFix;
begin
  ReplaceVmtField(TImage, @TFlickerlessImage.NewWndProc, @TFlickerlessImage.WndProc);
end;
{$ENDIF ImageFlickerFix}
{---------------------------------------------------------------------------}
